...
public class Decrypt_File extends Application
{
	...
	public void start(Stage arg0) throws Exception 
	{
		...
		hboxDesination.getChildren().addAll(txtFileDestinationEncrypted,  txtFileDestinationDecrypted);
	...
	private void encryptFile(String fileName, String saveFile, TextField txt) throws IOException 
	{
		...
		)
		{
			...
			txt.setText(saveFile + " has been decrypted");
